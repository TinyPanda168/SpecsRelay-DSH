...
**Turn a DeepSeek discussion into work a DSH project can continue.**

Open DeepSeek inside DSH Desktop and organize the complete conversation with one click. SpecsRelay extracts requirements, asks you to resolve material questions, then sends your confirmed requirements to the selected project and starts the Agent.

- **Keep your familiar webpage**: use your DeepSeek sign-in and conversation history.
- **Reuse your existing model**: use the model configured in DSH without entering its Key again.
- **Confirm the handoff**: review the requirements and project before sending and starting work.

> Supports only [DSH Desktop by anywhere-labs](https://github.com/anywhere-labs/deepseek-harness-desktop). This is an independent community project, not an official DeepSeek product or a built-in desktop feature.

[简体中文](README.md) | English

Latest update: **0.10.0 (2026-09-21)** — [Read the changelog](CHANGELOG.en.md)
...
[Quick install](#quick-install) · [Workflow](#workflow) · [Optional features](#optional-features) · [Data and security](#data-and-security)

## Why SpecsRelay exists

After discussing an idea, you often still need to copy a long conversation, sort out confirmed decisions, and tell a coding Agent which project to use. SpecsRelay handles that handoff.

| Step | Responsibility |
| --- | --- |
| DeepSeek | Discuss ideas, compare options, confirm decisions |
| SpecsRelay | Organize goals, constraints and acceptance criteria; clarify open questions |
| DSH Agent | Continue implementation in your selected local project |
...
See [DSH Desktop integration](docs/desktop-client-adapters.en.md) for detection, configuration directories and window modes.
...
[Setup, selection rules and advanced parameters →](docs/jev-features.en.md#long-conversation-enhancement)
...
[Configuration and data sent →](docs/jev-features.en.md#continuation-routing)
...
- Both Jev features are off by default. See [Jev data handling](docs/jev-features.en.md#data-sent-to-typesafe) for what enabling them sends.
